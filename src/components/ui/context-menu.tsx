...
// Mirrors dropdown-menu.tsx's own wrapper shape and styling exactly — Base
// UI's Menu popup/item primitives are shared between the two, only the
// trigger differs (right-click/long-press instead of click).
