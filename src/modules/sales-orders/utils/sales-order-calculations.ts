...
// Pure line/header arithmetic — mirrors quotation-calculations.ts exactly
// (36-sales-orders.md: "Line calculation... identical to 35-quotations.md's
// rules"). No I/O, no engine calls. Every comparison runs in integer paise
 ...
 * straight from that engine's result (sales-order-service.ts's
 * createSalesOrder). Summed in paise, per line, then converted to rupees once
 * at the end.
 */
