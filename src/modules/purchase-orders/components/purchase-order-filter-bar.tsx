...
/**
 * Search + status/supplier filters for the purchase order list — mirrors
 * sales-order-filter-bar.tsx's URL-state pattern exactly.
 */
export function PurchaseOrderFilterBar({ suppliers }: PurchaseOrderFilterBarProps) {
  ...
  return (
    <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-center">
      ...
      <FilterSelect
        ...
        options={PURCHASE_ORDER_STATUS_VALUES.map((value) => ({
          value,
