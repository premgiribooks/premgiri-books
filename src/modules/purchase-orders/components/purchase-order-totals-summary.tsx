...
import type { PurchaseOrderTotals } from "@/types/purchase-order";
 ...
 * (purchaseOrderService.previewPurchaseOrder / createPurchaseOrder), mirrors
 * sales-order-totals-summary.tsx exactly. */
export function PurchaseOrderTotalsSummary({ totals, groups }: PurchaseOrderTotalsSummaryProps) {
  return (
