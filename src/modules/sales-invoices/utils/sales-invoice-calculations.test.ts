...
describe("computeRoundOff", () => {
  it("rounds up: a fractional total above the half-paisa point produces a positive (CREDIT) round-off", () => {
  ...
  it("rounds down: a fractional total below the half-paisa point produces a negative (DEBIT) round-off", () => {
