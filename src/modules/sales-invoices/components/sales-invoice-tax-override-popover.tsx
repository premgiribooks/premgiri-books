...
interface SalesInvoiceTaxOverridePopoverProps {
  index: number;
...
/** Per-line "Override Tax" control (38-sales-invoice.md's spec-33 forward-
 * note) — a Popover instead of a separate dialog component to keep this to
 * one file; reveals the overridden amount fields plus a required reason. */
export function SalesInvoiceTaxOverridePopover({ index, isIntraState, isOverridden }: SalesInvoiceTaxOverridePopoverProps) {
